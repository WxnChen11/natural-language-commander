(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.NLC = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(_dereq_,module,exports){
"use strict";
...
var NaturalLanguageCommander = function () {
    ...
    function NaturalLanguageCommander() {
         ...
         * @param slotTypeName
         */
        this.removeSlotType = function (slotTypeName) {
            var intentUsingSlotType = _.find(_this.intents, function (intent) {
                var slotTypes = _.map(intent.slots || [], function (slot) {
                    return slot.type;
                });
            ...
            delete _this.slotTypes[slotTypeName];
        };
        /**
         ...
         */
        this.deregisterIntent = function (intentName) {
            if (!_this.doesIntentExist(intentName)) {
                return false;
            }
            // Remove the name from the name list.
            _this.intentNames = _.reject(_this.intentNames, function (name) {
                return name === intentName;
            });
            // Remove the intent.
            _this.intents = _.reject(_this.intents, { intent: intentName });
            // Remove matchers for the intent.
            _this.matchers = _.reject(_this.matchers, function (matcher) {
                return matcher.intent.intent === intentName;
            });
            return true;
        };
        /**
         ...
         */
        this.deregisterQuestion = function (questionName) {
            if (!_this.doesIntentExist(questionName)) {
                return false;
            }
            ...
            delete _this.questions[questionName];
            return true;
        };
        this.slotTypes = {};
        this.intentNames = [];
    ...
    (0, _createClass3.default)(NaturalLanguageCommander, [{
        ...
        key: "removeUtterance",
        value: function removeUtterance(intentName, utterance) {
            // Get the intent by name.
            var intent = _.find(this.intents, function (intent) {
                return intent.intent === intentName;
            });
            ...
            intent.utterances = _.reject(intent.utterances, function (intentUtterance) {
                return intentUtterance === utterance;
            });
            // Remove matchers for the intent.
            this.matchers = _.reject(this.matchers, function (matcher) {
                return matcher.originalUtterance === utterance;
            });
            return true;
        }
    }, {
        ...
        value: function handleCommand(dataOrCommandOrOptions, command) {
            ...
            delay(function () {
                ...
                if (_this2.getActiveQuestion(userId)) {
        ...
        value: function getActiveQuestion(userId) {
        ...
        value: function setActiveQuestion(userId, question) {
        ...
        value: function handleNormalCommand(data, command) {
            var matchesAndSlots = {};
            var shouldAddWholeMatches = true;
            ...
            _.forEach(this.matchers, function (matcher) {
                ...
                if (matchResults) {
                    ...
                    if (!wholeMatch || wholeMatch && shouldAddWholeMatches) {
                        var slots_length = foundSlots.reduce(function (a, c) {
                            return a + c ? c.length : 0;
                        }, 0);
                        var old_slots_length = 0;
                        if (matchesAndSlots.foundMatchName) {
                            old_slots_length = matchesAndSlots.foundMatchName.slots.reduce(function (a, c) {
                                return a + c ? c.length : 0;
                            }, 0);
                        }
            ...
            return _.map(matchesAndSlots, function (slots, name) {
...
},{"./lib/Deferred":2,"./lib/Matcher":3,"./lib/Question":4,"./lib/constants":6,"babel-runtime/core-js/set-immediate":10,"babel-runtime/helpers/classCallCheck":11,"babel-runtime/helpers/createClass":12,"lodash":88}],2:[function(_dereq_,module,exports){
"use strict";
...
var Matcher = function () {
    ...
    (0, _createClass3.default)(Matcher, [{
        ...
        key: "checkSlotMatch",
        value: function checkSlotMatch(slotText, slotTypeName) {
            // Handle unknown slot types.
            if (!this.slotTypes[slotTypeName]) {
                throw new Error("NLC: Slot Type " + slotTypeName + " not found!");
            }
            var slotType = this.slotTypes[slotTypeName];
            var slotOptions = slotType.matcher;
            var castedSlotRe = /\[([^\[\]]+)\:([^\[\]]+)\]/g;
            var match = castedSlotRe.exec(slotText);
            if (match) {
                var rawText = match[1];
                var castedType = match[2];
        ...
        key: "getRegexpSlot",
        value: function getRegexpSlot(slotText, slotType) {
        ...
        key: "getStringSlot",
        value: function getStringSlot(slotText, slotType) {
        ...
        key: "getFunctionSlotType",
        value: function getFunctionSlotType(slotText, slotType) {
        ...
        key: "getListSlotType",
        value: function getListSlotType(slotText, slotType) {
...
},{"./commonMistakes":5,"babel-runtime/core-js/json/stringify":7,"babel-runtime/helpers/classCallCheck":11,"babel-runtime/helpers/createClass":12,"lodash":88}],4:[function(_dereq_,module,exports){
"use strict";
...
var Question = function () {
    ...
    (0, _createClass3.default)(Question, [{
        ...
        key: "answer",
        value: function answer(_answer, data) {
            var _this = this;

            var commandPromise = void 0;
            // Handle the command, passing along data only if specified.
            if (data === undefined) {
                commandPromise = this.nlc.handleCommand(_answer);
            } else {
                commandPromise = this.nlc.handleCommand(data, _answer);
            }
...
},{"../../modules/_core":24,"../../modules/es6.object.define-property":80}],15:[function(_dereq_,module,exports){
...
},{"../modules/_core":24,"../modules/es6.object.to-string":81,"../modules/es6.promise":82,"../modules/es6.string.iterator":83,"../modules/es7.promise.finally":84,"../modules/es7.promise.try":85,"../modules/web.dom.iterable":86}],16:[function(_dereq_,module,exports){
_dereq_('../modules/web.immediate');
module.exports = _dereq_('../modules/_core').setImmediate;

},{"../modules/_core":24,"../modules/web.immediate":87}],17:[function(_dereq_,module,exports){
...
},{"./_to-absolute-index":69,"./_to-iobject":71,"./_to-length":72}],22:[function(_dereq_,module,exports){
...
},{"./_cof":23,"./_wks":77}],23:[function(_dereq_,module,exports){
...
},{"./_core":24,"./_ctx":25,"./_global":33,"./_has":34,"./_hide":35}],31:[function(_dereq_,module,exports){
...
},{"./_an-object":20,"./_ctx":25,"./_is-array-iter":40,"./_iter-call":42,"./_to-length":72,"./core.get-iterator-method":78}],33:[function(_dereq_,module,exports){
...
},{"./_descriptors":27,"./_object-dp":52,"./_property-desc":59}],36:[function(_dereq_,module,exports){
var document = _dereq_('./_global').document;
...
},{"./_iterators":47,"./_wks":77}],41:[function(_dereq_,module,exports){
module.exports = function (it) {
...
},{"./_hide":35,"./_object-create":51,"./_property-desc":59,"./_set-to-string-tag":63,"./_wks":77}],44:[function(_dereq_,module,exports){
'use strict';
...
},{"./_export":30,"./_hide":35,"./_iter-create":43,"./_iterators":47,"./_library":48,"./_object-gpo":54,"./_redefine":61,"./_set-to-string-tag":63,"./_wks":77}],45:[function(_dereq_,module,exports){
var ITERATOR = _dereq_('./_wks')('iterator');
...
},{"./_wks":77}],46:[function(_dereq_,module,exports){
...
},{"./_a-function":17}],51:[function(_dereq_,module,exports){
...
},{"./_an-object":20,"./_dom-create":28,"./_enum-bug-keys":29,"./_html":36,"./_object-dps":53,"./_shared-key":64}],52:[function(_dereq_,module,exports){
var anObject = _dereq_('./_an-object');
...
},{"./_an-object":20,"./_descriptors":27,"./_ie8-dom-define":37,"./_to-primitive":74}],53:[function(_dereq_,module,exports){
var dP = _dereq_('./_object-dp');
var anObject = _dereq_('./_an-object');
...
},{"./_an-object":20,"./_descriptors":27,"./_object-dp":52,"./_object-keys":56}],54:[function(_dereq_,module,exports){
...
},{"./_an-object":20,"./_is-object":41,"./_new-promise-capability":50}],59:[function(_dereq_,module,exports){
...
},{"./_hide":35}],62:[function(_dereq_,module,exports){
'use strict';
var global = _dereq_('./_global');
var core = _dereq_('./_core');
var dP = _dereq_('./_object-dp');
...
},{"./_core":24,"./_descriptors":27,"./_global":33,"./_object-dp":52,"./_wks":77}],63:[function(_dereq_,module,exports){
...
},{"./_has":34,"./_object-dp":52,"./_wks":77}],64:[function(_dereq_,module,exports){
...
},{"./_core":24,"./_global":33,"./_library":48}],66:[function(_dereq_,module,exports){
...
},{"./_a-function":17,"./_an-object":20,"./_wks":77}],67:[function(_dereq_,module,exports){
...
},{"./_global":33}],77:[function(_dereq_,module,exports){
...
},{"./_global":33,"./_shared":65,"./_uid":75}],78:[function(_dereq_,module,exports){
...
},{"./_classof":22,"./_core":24,"./_iterators":47,"./_wks":77}],79:[function(_dereq_,module,exports){
'use strict';
...
},{"./_add-to-unscopables":18,"./_iter-define":44,"./_iter-step":46,"./_iterators":47,"./_to-iobject":71}],80:[function(_dereq_,module,exports){
var $export = _dereq_('./_export');
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !_dereq_('./_descriptors'), 'Object', { defineProperty: _dereq_('./_object-dp').f });

},{"./_descriptors":27,"./_export":30,"./_object-dp":52}],81:[function(_dereq_,module,exports){
...
},{"./_a-function":17,"./_an-instance":19,"./_classof":22,"./_core":24,"./_ctx":25,"./_export":30,"./_for-of":32,"./_global":33,"./_is-object":41,"./_iter-detect":45,"./_library":48,"./_microtask":49,"./_new-promise-capability":50,"./_perform":57,"./_promise-resolve":58,"./_redefine-all":60,"./_set-species":62,"./_set-to-string-tag":63,"./_species-constructor":66,"./_task":68,"./_user-agent":76,"./_wks":77}],83:[function(_dereq_,module,exports){
'use strict';
...
},{"./_iter-define":44,"./_string-at":67}],84:[function(_dereq_,module,exports){
...
},{"./_core":24,"./_export":30,"./_global":33,"./_promise-resolve":58,"./_species-constructor":66}],85:[function(_dereq_,module,exports){
'use strict';
...
},{"./_export":30,"./_new-promise-capability":50,"./_perform":57}],86:[function(_dereq_,module,exports){
...
},{"./_global":33,"./_hide":35,"./_iterators":47,"./_wks":77,"./es6.array.iterator":79}],87:[function(_dereq_,module,exports){
var $export = _dereq_('./_export');
...
},{"./_export":30,"./_task":68}],88:[function(_dereq_,module,exports){
(function (global){
/**
 * @license
